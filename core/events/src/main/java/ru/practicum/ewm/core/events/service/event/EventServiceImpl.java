...
import ru.practicum.ewm.core.events.mapper.EventMapper;
import ru.practicum.ewm.core.events.repository.CategoryRepository;
...
public class EventServiceImpl implements EventService {
    ...
    public List<EventFullDto> getTopEvent(Long count) {
        ...
        List<Long> topEventIdList = publicCommentFeignClient.getTopEventIdList(count);

        List<Event> topEvents = eventRepository.findByIdIn(topEventIdList);
